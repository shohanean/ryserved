...
<head>
	...
	<link href="{{ asset('dashboard_assets') }}/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assets') }}/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assets') }}/vendor/jvmap/jquery-jvectormap.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assets') }}/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">

	<!-- tagify-css -->
	<link href="{{ asset('dashboard_assets') }}/vendor/tagify/dist/tagify.css" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											<div class="header-media">
												<img src="{{ session('auth_user')->data->hostDTO->img }}" alt="not found">
											</div>
											<div class="header-info">
												<h6>{{ session('auth_user')->data->hostDTO->first_name }} {{ session('auth_user')->data->hostDTO->last_name }}</h6>
												<p>{{ session('auth_user')->data->hostDTO->email }}</p>
											</div>
										...
										<tbody>
                                            @foreach ($hosts as $host)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="products">
                                                            <img src="{{ $host['img'] }}" class="avatar avatar-md" alt="not found">
                                                            <div>
                                                                <h6><a href="javascript:void(0)">{{ $host['first_name'] }}</a></h6>
                                                                <span>DOB: {{ $host['dob'] }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <span class="text-primary">{{ $host['phone'] }}</span>
                                                    </td>
                                                    <td>
									...
									<table id="empoloyees-tbl" class="table">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('dashboard_assets') }}/images/contacts/pic1.jpg" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('dashboard_assets') }}/images/contacts/pic2.jpg" class="avatar avatar-md" alt="">
														<div>
															<h6><a href="javascript:void(0)">Ricky Antony</a></h6>
															<span>Web Designer</span>
														</div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('dashboard_assets') }}/images/contacts/pic3.jpg" class="avatar avatar-md" alt="">
														<div>
    ...
    ***********************************-->
	...
	<script src="{{ asset('dashboard_assets') }}/vendor/draggable/draggable.js"></script>


	<!-- tagify -->
	<script src="{{ asset('dashboard_assets') }}/vendor/tagify/dist/tagify.js"></script>

	<script src="{{ asset('dashboard_assets') }}/vendor/datatables/js/jquery.dataTables.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/vendor/datatables/js/dataTables.buttons.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/vendor/datatables/js/buttons.html5.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/vendor/datatables/js/jszip.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/js/plugins-init/datatables.init.js"></script>

	<!-- Apex Chart -->

	<script src="{{ asset('dashboard_assets') }}/vendor/bootstrap-datetimepicker/js/moment.js"></script>
	<script src="{{ asset('dashboard_assets') }}/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>


	<!-- Vectormap -->
    <script src="{{ asset('dashboard_assets') }}/vendor/jqvmap/js/jquery.vmap.min.js"></script>
    <script src="{{ asset('dashboard_assets') }}/vendor/jqvmap/js/jquery.vmap.world.js"></script>
